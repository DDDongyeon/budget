        ...
        <div class="main">
            ...
            <div class="groupRecommend-box">
                ...
                <div class="requiredTag-box">
                    <div class="tag1" onclick="showGroupsByTag('청소년')">
                        <div class="tag1Letter">#청소년</div>
                    </div>
                    <div class="tag2" onclick="showGroupsByTag('대학생')">
                        <div class="tag2Letter">#대학생</div>
                    </div>
                    <div class="tag3" onclick="showGroupsByTag('취준생')">
                        <div class="tag3Letter">#취준생</div>
                    </div>
                    <div class="tag4" onclick="showGroupsByTag('직장인')">
